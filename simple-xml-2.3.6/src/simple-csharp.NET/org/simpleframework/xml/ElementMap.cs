...
namespace org.simpleframework.xml
{
	...
	/// <summary> The <code>ElementMap</code> annotation represents a method or field
	...
	/// <summary> Represents the type of key the element map contains. This
	...
	/// 
	/// </summary>
	/// <returns> the type of the entry key deserialized from the XML
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
	...
	/// <summary> Represents the type of value the element map contains. This
	...
	/// 
	/// </summary>
	/// <returns> the type of the entry value deserialized from the XML
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
