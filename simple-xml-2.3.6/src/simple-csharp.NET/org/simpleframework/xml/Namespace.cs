...
namespace org.simpleframework.xml
{
	...
	/// <summary> The <code>Namespace</code> annotation is used to set a namespace
	...
	public interface Namespace
	{
		...
		/// <summary> This is used to specify the unique reference URI that is used 
		...
		/// 
		/// </summary>
		/// <returns> this returns the reference used by this namespace    
		/// </returns>
	...
	/// <summary> This is used to specify the prefix used for the namespace. If
	...
	/// 
	/// </summary>
	/// <returns> this returns the prefix used for this namespace
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
