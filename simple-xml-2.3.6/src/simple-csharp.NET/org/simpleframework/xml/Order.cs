...
namespace org.simpleframework.xml
{
	...
	/// <summary> The <code>Order</code> annotation is used to specify the order of
	...
	public interface Order
	{
		...
		/// <summary> Specifies the appearance order of the XML elements within the
		...
		/// 
		/// </summary>
		/// <returns> an ordered array of elements representing order
		/// </returns>
	...
	/// <summary> Specifies the appearance order of the XML attributes within 
	...
	/// 
	/// </summary>
	/// <returns> an ordered array of attributes representing order
	/// </returns>
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
