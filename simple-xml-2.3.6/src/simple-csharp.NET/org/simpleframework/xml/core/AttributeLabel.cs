...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>AttributeLabel</code> object is used convert any value
	...
	class AttributeLabel : Label
	{
		...
		/// <summary> This is used to acquire the dependent type for this label. 
		...
		/// 
		/// </summary>
		/// <returns> this is used to return the dependent type or null
		/// </returns>
		...
		/// <summary> Constructor for the <code>AttributeLabel</code> object. This 
