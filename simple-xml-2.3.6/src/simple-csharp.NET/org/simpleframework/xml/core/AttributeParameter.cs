...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>AttributeParameter</code> represents a constructor 
	...
	class AttributeParameter : Parameter
	{
		...
		/// <summary> Constructor for the <code>AttributeParameter</code> object.
		...
		/// </param>
		public AttributeParameter(System.Reflection.ConstructorInfo factory, Attribute value_Renamed, int index)
		{
			this.contact = new Contact(value_Renamed, factory, index);
			this.label = new AttributeLabel(contact, value_Renamed);
		...
		private class Contact:ParameterContact
		{
			...
			< Attribute >
			public Contact(Attribute label, System.Reflection.ConstructorInfo factory, int index):base(label, factory, index)
			{
			}
		}
	}
