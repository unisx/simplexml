...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>Criteria</code> object represents the criteria used to
	...
	internal interface Criteria
	{
		...
		/// </returns>
		Variable get_Renamed(System.String name);
		...
		/// <returns> this returns the named variable if it exists
		/// </returns>
		Variable remove(System.String name);
		...
		/// 
		/// </summary>
		/// <param name="label">this is the label used to create the pointer
		/// </param>
		/// <param name="value">this is the value of the object to be read
		/// </param>
		void  set_Renamed(Label label, System.Object value_Renamed);
		...
		/// </param>
		void  commit(System.Object source);
	}
}