...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>ElementArrayParameter</code> represents a constructor 
	...
	/// </author>
	class ElementArrayParameter : Parameter
	{
		...
		/// <summary> Constructor for the <code>ElementArrayParameter</code> object.
		...
		/// </param>
		public ElementArrayParameter(System.Reflection.ConstructorInfo factory, ElementArray value_Renamed, int index)
		{
			this.contact = new Contact(value_Renamed, factory, index);
			this.label = new ElementArrayLabel(contact, value_Renamed);
		...
		private class Contact:ParameterContact
		{
			...
			< ElementArray >
			public Contact(ElementArray label, System.Reflection.ConstructorInfo factory, int index):base(label, factory, index)
			{
			}
		}
	}
