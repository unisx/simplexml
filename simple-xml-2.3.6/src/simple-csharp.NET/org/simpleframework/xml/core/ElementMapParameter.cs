...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>ElementMapParameter</code> represents a constructor 
	...
	/// </author>
	class ElementMapParameter : Parameter
	{
		...
		/// <summary> Constructor for the <code>ElementMapParameter</code> object.
		...
		/// </param>
		public ElementMapParameter(System.Reflection.ConstructorInfo factory, ElementMap value_Renamed, int index)
		{
			this.contact = new Contact(value_Renamed, factory, index);
			this.label = new ElementMapLabel(contact, value_Renamed);
		...
		private class Contact:ParameterContact
		{
			...
			< ElementMap >
			public Contact(ElementMap label, System.Reflection.ConstructorInfo factory, int index):base(label, factory, index)
			{
			}
		}
	}
