...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>ElementParameter</code> represents a constructor 
	...
	class ElementParameter : Parameter
	{
		...
		/// <summary> Constructor for the <code>ElementParameter</code> object.
		...
		/// </param>
		public ElementParameter(System.Reflection.ConstructorInfo factory, Element value_Renamed, int index)
		{
			this.contact = new Contact(value_Renamed, factory, index);
			this.label = new ElementLabel(contact, value_Renamed);
		...
		private class Contact:ParameterContact
		{
			...
			< Element >
			public Contact(Element label, System.Reflection.ConstructorInfo factory, int index):base(label, factory, index)
			{
			}
		}
	}
