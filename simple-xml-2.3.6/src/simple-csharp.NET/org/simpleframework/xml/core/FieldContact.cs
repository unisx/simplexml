...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>FieldContact</code> object is used to act as a contact
	...
	/// 
	/// </author>
	/// <seealso cref="org.simpleframework.xml.core.FieldScanner">
	/// </seealso>
	class FieldContact : Contact
	{
		...
		/// 
		/// </summary>
		/// <returns> this returns true if the contact is a static one
		/// </returns>
		...
		/// <summary> This is used to identify annotated methods are fields that
		/// can not be modified. Such field will require that there is 
		/// a constructor that can have the value injected in to it.
		/// 
		/// </summary>
		/// <returns> this returns true if the field or method is final
		/// </returns>
		virtual public bool Final
		{
			get
			{
				//UPGRADE_ISSUE: Method 'java.lang.reflect.Modifier.isFinal' was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1000_javalangreflectModifier'"
		...
		/// <summary> This is the label that marks the field within the object.</summary>
		private Annotation label;
		
		/// <summary> This represents the field within the schema class object.</summary>
		private System.Reflection.FieldInfo field;
		
		/// <summary> This is the name for this contact as taken from the field.</summary>
		private System.String name;
		
		/// <summary> This is the modifiers for the field that this represents.</summary>
		private int modifier;
		
		/// <summary> Constructor for the <code>FieldContact</code> object. This is 
		...
		/// 
		/// </summary>
		/// <param name="field">this is the field that is the point of contact
		/// </param>
		/// <param name="label">this is the annotation that is used by the field
		/// </param>
		public FieldContact(System.Reflection.FieldInfo field, Annotation label)
		{
			InitBlock();
		...
		/// <summary> This is used to acquire the name of the field. This will return
		...
		/// 
		/// </summary>
		/// <returns> this returns the name of the field represented
		/// </returns>
		...
		/// <summary> This is used to acquire the name of the field such that it is
		...
		/// 
		/// </summary>
		/// <param name="field">the field to acquire the internalized name from
		/// 
		/// </param>
		/// <returns> this returns the name of the string, internalized
		/// </returns>
		private System.String getName(System.Reflection.FieldInfo field)
		{
		...
		public virtual void  set_Renamed(System.Object source, System.Object value_Renamed)
		{
			if (!Final)
			{
				field.SetValue(source, value_Renamed);
			}
		}
