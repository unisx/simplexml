...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>Label</code> interface is used to describe an reference to
	...
	internal interface Label
	{
		...
		/// </returns>
		System.Object getEmpty(Context context);
		...
		/// </returns>
		System.String getName(Context context);
