...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>Repeater</code> interface is used to for converters that
	...
	/// 
	/// </author>
	/// <seealso cref="org.simpleframework.xml.core.CompositeInlineMap">
	/// </seealso>
	internal interface Repeater:Converter
	{
		...
		/// </param>
		/// <param name="value">this is the value to read the objects in to
		/// 
		/// </param>
		...
		new System.Object read(InputNode node, System.Object value_Renamed);
	}
}