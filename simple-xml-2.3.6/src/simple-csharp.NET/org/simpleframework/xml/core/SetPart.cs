...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>SetPart</code> object represents the setter method for
	...
	class SetPart : MethodPart
	{
		...
		/// 
		/// </summary>
		/// <returns> this returns the generic dependents for the type
		/// </returns>
		...
		/// <summary> This is the annotation for the set method provided.</summary>
		...
		/// <summary> This represents the method type for the set part method.</summary>
		...
		/// <summary> This method is used to set the value during deserialization. </summary>
		...
		/// <summary> This represents the name of this set part instance.</summary>
		...
		/// <summary> Constructor for the <code>SetPart</code> object. This is
		/// used to create a method part that will provide a means for 
		/// the deserialization process to set a value to a object.
		/// 
		/// </summary>
		/// <param name="method">the method that is used to set the value
		/// </param>
		/// <param name="label">this describes how to deserialize the value
		/// </param>
