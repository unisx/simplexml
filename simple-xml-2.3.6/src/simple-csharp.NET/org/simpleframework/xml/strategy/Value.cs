...
namespace org.simpleframework.xml.strategy
{
	...
	/// <summary> The <code>Value</code> object describes a type that is represented 
	...
	public interface Value
	{
		...
		/// 
		/// </summary>
		/// <returns> the type of the object that must be instantiated
		/// </returns>
		System.Type Type
		{
			get;
		...
		/// </param>
		void  setValue(System.Object value_Renamed);
		
		/// <summary> This will return true if the object represents a reference.
		/// A reference will provide a valid instance when this objects 
		/// getter is invoked. A valid instance can be a null.
		/// 
		/// </summary>
		/// <returns> this returns true if this represents a reference
		/// </returns>
		bool isReference();
	}
}