...
namespace org.simpleframework.xml.stream
{
	...
	/// <summary> The <code>EventToken</code> object is used to represent an event
	...
	/// </author>
	abstract class EventToken : EventNode
	{
		public EventToken()
		{
			InitBlock();
		...
		/// <summary> This provides the name of the event. Typically this will be
		...
		/// 
		/// </summary>
		/// <returns> this returns the name of this event or null
		/// </returns>
		...
		/// <summary> This is used to return the source of the event. Depending on
		...
		/// <summary> This is used to acquire the <code>Attribute</code> objects
		...
		/// 
		/// </summary>
		/// <returns> this returns an iterator for iterating attributes
		/// </returns>
