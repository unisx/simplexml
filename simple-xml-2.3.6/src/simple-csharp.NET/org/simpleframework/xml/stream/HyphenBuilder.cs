...
namespace org.simpleframework.xml.stream
{
	...
	/// <summary> The <code>HyphenBuilder</code> is used to represent an XML style
	...
	class HyphenBuilder : Style
	{
		...
		public virtual System.String getAttribute(System.String name)
		{
			if (name != null)
			{
				return new Parser(this, name).process();
			}
			return null;
		}
		...
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'Parser' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		...
		{
			private void  InitBlock(HyphenBuilder enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private HyphenBuilder enclosingInstance;
			public HyphenBuilder Enclosing_Instance
			{
				get
				{
			...
			/// <summary> Constructor for the <code>Parser</code> object. This will
			...
			/// </param>
			internal Parser(HyphenBuilder enclosingInstance, System.String source):base(source)
			{
