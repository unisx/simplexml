...
namespace org.simpleframework.xml.transform
{
	...
	/// <summary> The <code>BigIntegerTransform</code> is used to transform integer
	...
	/// </author>
	class BigIntegerTransform : Transform
	{
		...
		public virtual System.Decimal read(System.String value_Renamed)
		{
			//UPGRADE_WARNING: Constructor 'java.math.BigInteger.BigInteger' was converted to 'System.Decimal.Parse' which may throw an exception. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1101'"
		...
		/// </returns>
		//UPGRADE_TODO: Class 'java.math.BigInteger' was converted to 'System.Decimal' which has a different behavior. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1073_javamathBigInteger'"
		public virtual System.String write(System.Decimal value_Renamed)
		{
