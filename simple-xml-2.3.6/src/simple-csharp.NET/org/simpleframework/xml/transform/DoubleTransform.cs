...
namespace org.simpleframework.xml.transform
{
	...
	/// <summary> The <code>DoubleTransform</code> is used to transform double
	...
	class DoubleTransform : Transform
	{
		...
		< Double >
		public virtual System.Double read(System.String value_Renamed)
		{
		...
		public virtual System.String write(ref System.Double value_Renamed)
		{
