...
namespace org.simpleframework.xml.transform
{
	...
	/// <summary> The <code>Matcher</code> is used to match a type with a transform
	...
	public interface Matcher
	{
		...
		/// 
		/// </returns>
		/// <throws>  Exception thrown if a transform could not be found </throws>
		Transform match(System.Type type);
	}
}