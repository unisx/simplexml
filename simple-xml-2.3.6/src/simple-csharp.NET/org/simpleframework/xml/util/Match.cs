...
namespace org.simpleframework.xml.util
{
	...
	/// <summary> This object is stored within a <code>Resolver</code> so that it 
	...
	{
		/// <summary> This is the pattern string that is used by the resolver. A
		...
		/// 
		/// </summary>
		/// <returns> this returns the pattern that is to be matched
		/// </returns>
