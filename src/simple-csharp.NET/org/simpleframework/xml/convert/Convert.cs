...
namespace org.simpleframework.xml.convert
{
	...
	/// <summary> The <code>Convert</code> annotation is used to specify a converter
	...
	public interface Convert
	{
		...
		/// <summary> Specifies the <code>Converter</code> implementation to be used
		...
		/// 
		/// </summary>
		/// <returns> this returns the converter that has been specified
		/// </returns>
	}
	//UPGRADE_ISSUE: The following fragment of code could not be parsed and was not converted. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1156'"
