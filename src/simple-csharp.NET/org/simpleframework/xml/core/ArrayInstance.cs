...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>ArrayInstance</code> object is used for creating arrays
	...
	class ArrayInstance : Instance
	{
		...
		/// <summary> This is the value object that contains the criteria.</summary>
		...
		/// <summary> This is the array component type for the created array.</summary>
		...
		/// <summary> This is the length of the array to be instantiated.</summary>
		...
		/// <summary> Constructor for the <code>ArrayInstance</code> object. This
		/// is used to create an object that can create an array of the
		/// given length and specified component type.
		/// 
		/// </summary>
		/// <param name="value">this is the value object describing the instance
		/// </param>
		public ArrayInstance(Value value_Renamed)
		{
			this.length = value_Renamed.Length;
		...
		public virtual System.Object getInstance()
		{
			...
			System.Object array = System.Array.CreateInstance(type, length);
			
			if (value_Renamed != null)
			{
				value_Renamed.setValue(array);
			}
			return array;
		}
		...
		/// 
		/// </summary>
		/// <param name="array">this is the array to insert as the value
		/// 
		/// </param>
		/// <returns> an instance of the type this object represents
		/// </returns>
		public virtual System.Object setInstance(System.Object array)
		{
			if (value_Renamed != null)
			{
				value_Renamed.setValue(array);
