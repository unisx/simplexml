...
namespace org.simpleframework.xml.core
{
	...
	/// <summary> The <code>ElementLabel</code> represents a label that is used to
	...
	/// 
	/// </author>
	/// <seealso cref="org.simpleframework.xml.Element">
	/// </seealso>
	class ElementLabel : Label
	{
		...
		/// 
		/// </summary>
		/// <returns> this always returns false for element labels
		/// </returns>
		...
		/// <summary> The contact that this element label represents.</summary>
		private Signature detail;
		
		/// <summary> References the annotation that was used by the field.</summary>
		...
		/// <summary> Constructor for the <code>ElementLabel</code> object. This is
		/// used to create a label that can convert a XML node into a 
		/// composite object or a primitive type from an XML element. 
		/// 
		/// </summary>
		/// <param name="contact">this is the field that this label represents
		/// </param>
		...
		/// 
		/// </summary>
		/// <param name="context">this is used to provide a styled name
		/// 
		/// </param>
