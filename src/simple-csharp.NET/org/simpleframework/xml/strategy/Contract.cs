...
namespace org.simpleframework.xml.strategy
{
	...
	/// <summary> The <code>Contract</code> object is used to expose the attribute
	...
	class Contract
	{
		/// <summary> This is returns the attribute used to store information about
		...
		/// 
		/// </summary>
		/// <returns> the name of the attribute used to store the type
		/// </returns>
		...
		/// <summary> This returns the attribute used to store references within the
		...
		/// 
		/// </summary>
		/// <returns> this returns the name of the reference attribute
		/// </returns>
		...
		/// <summary> This returns the attribute used to store the identities of all
		...
		/// 
		/// </summary>
		/// <returns> this returns the name of the identity attribute used
		/// </returns>
		...
		/// <summary> This returns the attribute used to store the array length in
		...
		/// 
		/// </summary>
		/// <returns> this returns the name of the array length attribute
		/// </returns>
		virtual public System.String Length
		{
			get
			{
				return length;
		...
		/// <summary> Constructor for the <code>Syntax</code> object. This is used
		...
		/// </param>
		public Contract(System.String mark, System.String refer, System.String label, System.String length)
		{
			this.length = length;
			this.label = label;
			this.refer = refer;
