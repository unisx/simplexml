...
namespace org.simpleframework.xml.strategy
{
	...
	/// <summary> The <code>WriteState</code> object is used to store all graphs that
	...
	class WriteState:WeakCache
	{
		...
		/// <summary> Constructor for the <code>WriteState</code> object. This is
		...
		/// 
		/// </param>
		/// <returns> returns a graph used for writing the XML document
		/// </returns>
		public virtual WriteGraph find(System.Object map)
		{
