...
namespace org.simpleframework.xml.stream
{
	...
	/// <summary> The <code>Attribute</code> interface represents an attribute that
	...
	/// 
	/// </author>
	/// <seealso cref="org.simpleframework.xml.stream.EventNode">
	/// </seealso>
	internal interface Attribute
	{
		/// <summary> This provides the name of the attribute. This should be the
		...
		/// 
		/// </summary>
		/// <returns> this returns the value represented by this attribute
		/// </returns>
		System.String Value
		{
			get;
		...
		/// <summary> This is used to return the source of the attribute. Depending 
