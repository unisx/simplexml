...
namespace org.simpleframework.xml.stream
{
	...
	/// <summary> The <code>InputNode</code> object represents an iterator for the
	...
	public interface InputNode:Node
	{
		...
		/// 
		/// </summary>
		/// <returns> this returns true if the node is an element node
		/// </returns>
		bool Element
		{
			get;
		...
		/// </returns>
		InputNode getAttribute(System.String name);
	...
	/// <summary> This returns the next child element within this element if
	/// one exists. If all children have been read, or if there are
	/// no child elements for this element then this returns null.
	/// 
	/// </summary>
	/// <returns> this returns an input node for the next child
	/// 
	/// </returns>
	...
	/// <summary> This returns the next child in this element if that child
	/// has the name provided. If the next child element in this
	/// node does not have the name given then null is returned.
	/// 
	/// </summary>
	/// <param name="name">this is the name of the next child element 
	/// 
	/// </param>
	/// <returns> the next element if it has the name specified
	/// 
	/// </returns>
	/// <exception cref="Exception">thrown if there was a parse error
	/// </exception>
