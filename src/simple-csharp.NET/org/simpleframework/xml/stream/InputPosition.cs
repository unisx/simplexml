...
namespace org.simpleframework.xml.stream
{
	...
	/// <summary> The <code>InputPosition</code> object is used to acquire the line
	...
	{
		/// <summary> This is the actual line number within the read XML document. 
		...
		/// 
		/// </summary>
		/// <returns> this returns the line number of an XML event 
		/// </returns>
		...
		/// <summary> This is the XML event that the position is acquired for.</summary>
		private EventNode source;
		
		/// <summary> Constructor for the <code>InputPosition</code> object. This is
		...
		/// 
		/// </summary>
		/// <param name="source">this is the XML event to get the position of
		/// </param>
		...
		/// <summary> This provides a textual description of the position the 
		/// read cursor is at within the XML document. This allows the
		/// position to be embedded within the exception thrown.
		/// 
		/// </summary>
		/// <returns> this returns a textual description of the position
		/// </returns>
