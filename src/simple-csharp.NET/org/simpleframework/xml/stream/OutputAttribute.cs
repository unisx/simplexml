...
namespace org.simpleframework.xml.stream
{
	...
	/// <summary> The <code>OutputAttribute</code> object is used to represent a 
	...
	class OutputAttribute : OutputNode
	{
		...
		/// <summary> This is used to determine whether the node has been committed.
		/// If the node has been committed, then this will return true.
		/// When committed the node can no longer produce child nodes.
		/// 
		/// </summary>
		/// <returns> true if this node has already been committed
		/// </returns>
		...
		/// <summary> This contains the namespaces for the parent element.</summary>
		private NamespaceMap scope;
		
		/// <summary> Represents the output node that this node requires.</summary>
		private OutputNode source;
		
		/// <summary> Represents the namespace reference for this node.</summary>
		private System.String reference;
		
		/// <summary> Represents the name of this node object instance.</summary>
		private System.String name;
		
		/// <summary> Represents the value of this node object instance.</summary>
		private System.String value_Renamed;
		
		/// <summary> Constructor for the <code>OutputAttribute</code> object. This 
		/// is used to create a simple name value pair attribute holder.
		/// 
		/// </summary>
		/// <param name="name">this is the name that is used for the node
		/// </param>
		/// <param name="value">this is the value used for the node
		/// </param>
		public OutputAttribute(OutputNode source, System.String name, System.String value_Renamed)
		{
			InitBlock();
		...
		/// <summary> This is used to set a text value to the attribute. This should
		/// be added to the attribute if the attribute is to be written 
		/// to the parent element. Without a value this is invalid.
		/// 
		/// </summary>
		/// <param name="value">this is the text value to add to this attribute
		/// </param>
		...
		{
			return scope.get_Renamed(reference);
		}
		...
		/// <summary> The <code>commit</code> method is used flush and commit any 
		...
		/// <summary> This is used to acquire the name and value of the attribute.
		/// Implementing this method ensures that debugging the output
		/// node is simplified as it is possible to get the actual value.
		/// 
		/// </summary>
		/// <returns> this returns the details of this output node
		/// </returns>
