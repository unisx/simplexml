...
namespace org.simpleframework.xml.stream
{
	...
	/// <summary> The <code>OutputElement</code> object represents an XML element.  
	...
	class OutputElement : OutputNode
	{
		...
		/// <summary> This is used to acquire the namespace URI reference associated
		...
		/// 
		/// </summary>
		/// <returns> this returns the namespace URI reference for this
		/// </returns>
		/// <summary> This is used to set the reference for the node. Setting the
		...
		/// 
		/// </summary>
		/// <param name="reference">this is used to set the reference for the node
		/// </param>
		...
		/// <summary> This returns the <code>NamespaceMap</code> for this node. Only
		...
		/// 
		/// </summary>
		/// <returns> this returns the namespaces associated with the node
		/// </returns>
		...
		/// </returns>
		virtual public OutputNodeMap Attributes
		{
			get
			{
				return table;
		...
		/// 
		/// </summary>
		/// <returns> true if the node has been committed
		/// </returns>
		...
		/// <summary> Represents the attributes that have been set for the element.</summary>
		private OutputNodeMap table;
		
		/// <summary> This is the namespace map that contains the namespaces.</summary>
		private NamespaceMap scope;
		
		/// <summary> Used to write the start tag and attributes for the document.</summary>
		private NodeWriter writer;
		
		/// <summary> This is the parent XML element to this output node.</summary>
		private OutputNode parent;
		
		/// <summary> This is the namespace reference URI associated with this.</summary>
		private System.String reference;
		
		/// <summary> This is the comment that has been set on this element.</summary>
		private System.String comment;
		
		/// <summary> Represents the value that has been set for the element.</summary>
		private System.String value_Renamed;
		
		/// <summary> Represents the name of the element for this output node.</summary>
		private System.String name;
		
		/// <summary> This is the output mode that this element object is using.</summary>
		private Mode mode;
		
		/// <summary> Constructor for the <code>OutputElement</code> object. This is
		...
		/// 
		/// </summary>
		/// <param name="parent">this is the parent node to this output node
		/// </param>
		/// <param name="writer">this is the writer used to generate the file
		/// </param>
		/// <param name="name">this is the name of the element this represents
		/// </param>
		public OutputElement(OutputNode parent, NodeWriter writer, System.String name)
		{
		...
		/// <summary> This is used to acquire the prefix for this output node. This 
		...
		/// <summary> This is used to acquire the prefix for this output node. If
		...
		{
			System.String prefix = scope.get_Renamed(reference);
		...
		/// <summary> This is used to set a text value to the element. This should
		...
		/// <summary> This method is used for convinience to add an attribute node 
		...
		/// 
		/// </param>
		/// <returns> this will return the attribute that was just set
		/// </returns>
