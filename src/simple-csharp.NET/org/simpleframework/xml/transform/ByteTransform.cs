...
namespace org.simpleframework.xml.transform
{
	...
	/// <summary> The <code>ByteTransform</code> object is used to transform byte
	...
	class ByteTransform : Transform
	{
		...
		< Byte >
		public virtual System.SByte read(System.String value_Renamed)
		{
		...
		public virtual System.String write(ref System.SByte value_Renamed)
		{
