...
namespace org.simpleframework.xml.transform
{
	...
	/// <summary> The <code>CurrencyTransform</code> is used to transform currency
	...
	class CurrencyTransform : Transform
	{
		...
		/// 
		/// </summary>
		/// <param name="symbol">the string representation of the currency 
		/// 
		/// </param>
		...
		< Currency >
		public virtual Currency read(System.String symbol)
		{
		...
		/// 
		/// </summary>
		/// <param name="currency">this is the value to be converted to a string
		/// 
		/// </param>
		/// <returns> this is the string representation of the given value
		/// </returns>
		public virtual System.String write(Currency currency)
		{
