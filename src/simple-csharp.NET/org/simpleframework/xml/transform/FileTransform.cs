...
namespace org.simpleframework.xml.transform
{
	...
	/// <summary> The <code>FileTransform</code> object is used to transform file
	...
	class FileTransform : Transform
	{
		...
		/// 
		/// </summary>
		/// <param name="path">this is the string representation of the path
		/// 
		/// </param>
		...
		< File >
		public virtual System.IO.FileInfo read(System.String path)
		{
		...
		/// 
		/// </summary>
		/// <param name="path">this is the value to be converted to a string
		/// 
		/// </param>
		/// <returns> this is the string representation of the given value
		/// </returns>
		public virtual System.String write(System.IO.FileInfo path)
		{
