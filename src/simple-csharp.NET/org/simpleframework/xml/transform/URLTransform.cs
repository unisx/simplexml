...
namespace org.simpleframework.xml.transform
{
	...
	/// <summary> The <code>URLTransform</code> object is used to transform URL
	...
	class URLTransform : Transform
	{
		...
		/// 
		/// </summary>
		/// <param name="target">this is the string representation of the URL
		/// 
		/// </param>
		...
		< URL >
		public virtual System.Uri read(System.String target)
		{
		...
		/// </returns>
		public virtual System.String write(System.Uri target)
		{
